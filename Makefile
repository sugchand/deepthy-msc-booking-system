...
## Lint:
lint: lint-go fmt-go lint-dockerfile lint-yaml ## Run all available linters
...
lint-go: ## Use golintci-lint on your project
	...
	docker run --rm -v $(shell pwd):/app -w /app golangci/golangci-lint:latest-alpine golangci-lint run -v --deadline=65s $(OUTPUT_OPTIONS)

fmt-go: ## Use gofmt on your project
	gofmt -l -s .
